/* global d3, w, nodes, h, all, responsiveVoice, sizeOfImageHistoryBar, listOfImageHistoryBarElement, donorsNameElement, newImgElement, dataset, df_list */
...
// store data from csv to global lists
var df_lst = [], lst = [];
